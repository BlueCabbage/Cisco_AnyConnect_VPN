...
LOGFNAME=`/bin/date "+posture-4.2.05015-install-%H%M%S%d%m%Y.log"` ||
  LOGFNAME=`/usr/bin/date "+posture-4.2.05015-install-%H%M%S%d%m%Y.log"` ||
  LOGFNAME=`date "+posture-4.2.05015-install-%H%M%S%d%m%Y.log"` ||
  LOGFNAME=posture-4.2.05015-install.log
...
echo "Installing Cisco AnyConnect Posture Module v4.2.05015..." > /tmp/${LOGFNAME}
